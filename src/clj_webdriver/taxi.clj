...
(defn find-table-cell [table-q coords] (core/find-table-cell *driver* (*finder-fn* table-q) coords))
(defn find-table-row [table-q row] (core/find-table-row *driver* (*finder-fn* table-q) row))
